...
$page = new CLoggedPage("", "html/" . $g_theme . "/buyvip.html");
...
class CVipSale extends CHtmlBlock
{
	var $m_db = null;
	var $sMessage = "";

	function CVipSale ($db, $name, $html_path)
	{
		$this->CHtmlBlock($name, $html_path);
		$this->m_db = $db;
	}
...
$aVipSale = new CVipSale($db, "fVipSale", null);
$page->add($aVipSale);
